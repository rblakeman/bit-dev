...
Run the following to create a Node (express) app using a [component template](/dev-services/generator/generator-overview):
...
Search [bit.cloud](https://bit.cloud) for an app component that best fits your needs, and [fork](/components/forking-components) it to your workspace. This will provide you with a new component that has much of its boilerplate written for you.
