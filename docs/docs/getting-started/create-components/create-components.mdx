...
Components can be of various types. Create a React component, to experiment with a client-side UI component. Alternatively, create a Node component to experiment with a server-side component.
